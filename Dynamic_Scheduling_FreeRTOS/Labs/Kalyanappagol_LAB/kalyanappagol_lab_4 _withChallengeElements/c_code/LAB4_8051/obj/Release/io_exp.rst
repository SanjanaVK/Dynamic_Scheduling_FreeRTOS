   ...
   1208                     672 _ioexp_dir:
                            ...
                            674 ;	genIpush
   1208 74 BC               675 	mov	a,#__str_0
   120A C0 E0               676 	push	acc
   120C 74 4E               677 	mov	a,#(__str_0 >> 8)
   120E C0 E0               678 	push	acc
                            679 ;	genCall
   1210 12 3B D4            680 	lcall	_printf_tiny
   ...
   1217                     684 00105$:
                            ...
                            686 ;	genCall
   1217 12 38 30            687 	lcall	_getstr
   ...
   1226 74 E1               696 	mov	a,#__str_1
   1228 C0 E0               697 	push	acc
   122A 74 4E               698 	mov	a,#(__str_1 >> 8)
   122C C0 E0               699 	push	acc
                            700 ;	genCall
   122E 12 3B D4            701 	lcall	_printf_tiny
   ...
   1247 12 38 B3            715 	lcall	_putstr
   ...
   1256 74 FF               724 	mov	a,#__str_2
   1258 C0 E0               725 	push	acc
   125A 74 4E               726 	mov	a,#(__str_2 >> 8)
   125C C0 E0               727 	push	acc
                            728 ;	genCall
   125E 12 3B D4            729 	lcall	_printf_tiny
   ...
   1295 74 02               778 	mov	a,#__str_3
   1297 C0 E0               779 	push	acc
   1299 74 4F               780 	mov	a,#(__str_3 >> 8)
   129B C0 E0               781 	push	acc
                            782 ;	genCall
   129D 12 3B D4            783 	lcall	_printf_tiny
   ...
   12CB 74 39               823 	mov	a,#__str_4
   12CD C0 E0               824 	push	acc
   12CF 74 4F               825 	mov	a,#(__str_4 >> 8)
   12D1 C0 E0               826 	push	acc
                            827 ;	genCall
   12D3 12 3B D4            828 	lcall	_printf_tiny
   ...
   12E2 12 38 30            839 	lcall	_getstr
   ...
   12F9 74 6C               852 	mov	a,#__str_5
   12FB C0 E0               853 	push	acc
   12FD 74 4F               854 	mov	a,#(__str_5 >> 8)
   12FF C0 E0               855 	push	acc
                            856 ;	genCall
   1301 12 3B D4            857 	lcall	_printf_tiny
   ...
   1322 12 38 B3            875 	lcall	_putstr
   ...
   1339 74 FF               888 	mov	a,#__str_2
   133B C0 E0               889 	push	acc
   133D 74 4E               890 	mov	a,#(__str_2 >> 8)
   133F C0 E0               891 	push	acc
                            892 ;	genCall
   1341 12 3B D4            893 	lcall	_printf_tiny
   ...
   137B 74 90               934 	mov	a,#__str_6
   137D C0 E0               935 	push	acc
   137F 74 4F               936 	mov	a,#(__str_6 >> 8)
   1381 C0 E0               937 	push	acc
                            938 ;	genCall
   1383 12 3B D4            939 	lcall	_printf_tiny
   ...
   13CA 12 3F C4            992 	lcall	___uint2fs
   ...
   13D6 D0 02               998 	pop	ar2
                            999 ;	genAssign
   13D8 90 01 AA           1000 	mov	dptr,#_powf_PARM_2
   ...
   13F2 12 3C FC           1021 	lcall	_powf
   ...
   1414 12 39 07           1040 	lcall	___fssub
   ...
   1433 12 3F D0           1057 	lcall	___fs2uint
   ...
   14CB 74 C7              1200 	mov	a,#__str_7
   14CD C0 E0              1201 	push	acc
   14CF 74 4F              1202 	mov	a,#(__str_7 >> 8)
   14D1 C0 E0              1203 	push	acc
                           1204 ;	genCall
   14D3 12 3B D4           1205 	lcall	_printf_tiny
   ...
   14E6 12 38 97           1216 	lcall	_putchar
   ...
   14F1 74 FF              1223 	mov	a,#__str_2
   14F3 C0 E0              1224 	push	acc
   14F5 74 4E              1225 	mov	a,#(__str_2 >> 8)
   14F7 C0 E0              1226 	push	acc
                           1227 ;	genCall
   14F9 12 3B D4           1228 	lcall	_printf_tiny
   ...
   4EBC                    1290 __str_0:
   4EBC 0A                 1291 	.db 0x0A
   4EBD 0A                 1292 	.db 0x0A
   4EBE 0D                 1293 	.db 0x0D
   4EBF 09                 1294 	.db 0x09
   4EC0 20 53 65 6C 65 63  1295 	.ascii " Select pin number from 1 to 3: "
        74 20 70 69 6E 20
        6E 75 6D 62 65 72
        20 66 72 6F 6D 20
        31 20 74 6F 20 33
        3A 20
   4EE0 00                 1296 	.db 0x00
   4EE1                    1297 __str_1:
   4EE1 54 68 65 20 70 69  1298 	.ascii "The pin you have selected is:"
        6E 20 79 6F 75 20
        68 61 76 65 20 73
        65 6C 65 63 74 65
        64 20 69 73 3A
   4EFE 00                 1299 	.db 0x00
   4EFF                    1300 __str_2:
   4EFF 0D                 1301 	.db 0x0D
   4F00 0A                 1302 	.db 0x0A
   4F01 00                 1303 	.db 0x00
   4F02                    1304 __str_3:
   4F02 0A                 1305 	.db 0x0A
   4F03 0A                 1306 	.db 0x0A
   4F04 0D                 1307 	.db 0x0D
   4F05 20 2A 2D 45 52 52  1308 	.ascii " *-ERROR-*"
        4F 52 2D 2A
   4F0F 0A                 1309 	.db 0x0A
   4F10 0D                 1310 	.db 0x0D
   4F11 09                 1311 	.db 0x09
   4F12 20 45 6E 74 65 72  1312 	.ascii " Enter a valid number between 1 to 3: "
        20 61 20 76 61 6C
        69 64 20 6E 75 6D
        62 65 72 20 62 65
        74 77 65 65 6E 20
        31 20 74 6F 20 33
        3A 20
   4F38 00                 1313 	.db 0x00
   4F39                    1314 __str_4:
   4F39 0A                 1315 	.db 0x0A
   4F3A 0A                 1316 	.db 0x0A
   4F3B 0D                 1317 	.db 0x0D
   4F3C 09                 1318 	.db 0x09
   4F3D 20 53 65 6C 65 63  1319 	.ascii " Select Direction of pin:  0.Output  1. Input"
        74 20 44 69 72 65
        63 74 69 6F 6E 20
        6F 66 20 70 69 6E
        3A 20 20 30 2E 4F
        ...
        20 31 2E 20 49 6E
        70 75 74
   4F6A 09                 1320 	.db 0x09
   4F6B 00                 1321 	.db 0x00
   4F6C                    1322 __str_5:
   4F6C 54 68 65 20 64 69  1323 	.ascii "The direction you have selected is:"
        72 65 63 74 69 6F
        6E 20 79 6F 75 20
        68 61 76 65 20 73
        65 6C 65 63 74 65
        64 20 69 73 3A
   4F8F 00                 1324 	.db 0x00
   4F90                    1325 __str_6:
   4F90 0A                 1326 	.db 0x0A
   4F91 0A                 1327 	.db 0x0A
   4F92 0D                 1328 	.db 0x0D
   4F93 20 2A 2D 45 52 52  1329 	.ascii " *-ERROR-*"
        4F 52 2D 2A
   4F9D 0A                 1330 	.db 0x0A
   4F9E 0D                 1331 	.db 0x0D
   4F9F 09                 1332 	.db 0x09
   4FA0 20 45 6E 74 65 72  1333 	.ascii " Enter a valid number between 0 or 1: "
        20 61 20 76 61 6C
        69 64 20 6E 75 6D
        62 65 72 20 62 65
        74 77 65 65 6E 20
        30 20 6F 72 20 31
        3A 20
   4FC6 00                 1334 	.db 0x00
   4FC7                    1335 __str_7:
   4FC7 54 68 65 20 63 6F  1336 	.ascii "The count is: "
        75 6E 74 20 69 73
        3A 20
   4FD5 00                 1337 	.db 0x00
