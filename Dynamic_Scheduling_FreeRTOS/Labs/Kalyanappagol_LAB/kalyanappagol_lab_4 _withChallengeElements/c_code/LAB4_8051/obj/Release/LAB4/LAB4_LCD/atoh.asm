...
; This file generated Mon Apr 24 20:04:30 2017
;--------------------------------------------------------
	.module atoh
...
;	genReceive
	...
	mov	a,r2
	movx	@dptr,a
;	atoh.c:37: if(*(c+3) != '\0')                  // Checking if recieved string is 3 digit number
;	genAssign
	mov	dptr,#_atoh_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	atoh.c:39: return  ATOH_ERRORVALUE;
;	genRet
...
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00102$:
;	atoh.c:42: if(*(c)>=48 && *(c)<=55 )           // multiply digit at 100th place by 256
;	genPointerGet
;	genGenPointerGet
	mov	dpl,r2
	mov	dph,r3
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00105$
00104$:
;	atoh.c:47: else{return ATOH_ERRORVALUE;}
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x2100
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00105$:
;	atoh.c:50: if(*(c)>=48 && *(c)<=57 )           // Multiply 10th place digit by 16
;	genAssign
	mov	dptr,#_atoh_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00117$
00108$:
;	atoh.c:67: return  ATOH_ERRORVALUE;
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x2100
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00117$:
;	atoh.c:72: if(*(c)>=48 && *(c)<=57)  //Convert unit place digit to an ascii
;	genAssign
	mov	dptr,#_atoh_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00129$
00120$:
;	atoh.c:86: return  ATOH_ERRORVALUE;                        // If the unit place digit is not valid then return error
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x2100
;	Peephole 112.b	changed ljmp to sjmp
...
;------------------------------------------------------------
;	atoh.c:101: int atoh_data(char *c)
;	-----------------------------------------
;	 function atoh_data
;	-----------------------------------------
_atoh_data:
;	genReceive
	...
	mov	a,r2
	movx	@dptr,a
;	atoh.c:105: if(*(c+2) != '\0')     //Check if 2 digit number string is received
;	genAssign
	mov	dptr,#_atoh_data_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	atoh.c:107: return ATOHDATA_ERRORVALUE;
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0101
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00102$:
;	atoh.c:110: if(*(c)>=48 && *(c)<=57 )  //Multiply 10th place by 16
;	genPointerGet
;	genGenPointerGet
	mov	dpl,r2
	mov	dph,r3
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00113$
00104$:
;	atoh.c:127: return ATOHDATA_ERRORVALUE; // If the 100th place digit is not valid then return error
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0101
;	Peephole 251.a	replaced ljmp to ret with ret
	ret
00113$:
;	atoh.c:132: if(*(c)>=48 && *(c)<=57)  //convert unit place digit to ascii
;	genAssign
	mov	dptr,#_atoh_data_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00125$
00116$:
;	atoh.c:146: return ATOHDATA_ERRORVALUE; // If the unit place digit is not valid then return error
;	genRet
;	Peephole 182.b	used 16 bit load of dptr
	mov	dptr,#0x0101
;	Peephole 112.b	changed ljmp to sjmp
...
;	genReceive
	...
	mov	a,r2
	movx	@dptr,a
;	atoh.c:164: if(c<10)        //Check if the character is less than 10
;	genAssign
	mov	dptr,#_ctoa_c_1_1
	movx	a,@dptr
	mov	r2,a
...
;	atoh.c:166: d=ASCIIZERO;
;	genAssign
	mov	dptr,#_ctoa_d_1_1
	mov	a,#0x30
	movx	@dptr,a
;	atoh.c:167: for(i=0;i<10;i++) //return appropriate ascii value for number less than 10
;	genAssign
	mov	ar4,r2
	mov	ar5,r3
;	genAssign
...
;	Peephole 112.b	changed ljmp to sjmp
	sjmp	00104$
00118$:
;	atoh.c:177: else if(c<16)  //Check if the character is more than 10 and less than 16
;	genCmpLt
;	genCmp
	clr	c
	mov	a,r2
...
;	atoh.c:179: d=ASCIICAPITAL_A;
;	genAssign
	mov	dptr,#_ctoa_d_1_1
	mov	a,#0x41
	movx	@dptr,a
;	atoh.c:180: for(i=10;i<16;i++) //return appropriate ascii value for character less than 16
;	genAssign
;	genAssign
	mov	r4,#0x41
;	genAssign
...
;------------------------------------------------------------
;	atoh.c:203: unsigned char atob(unsigned char c)
;	-----------------------------------------
;	 function atob
;	-----------------------------------------
_atob:
;	genReceive
	...
	movx	@dptr,a
;	atoh.c:206: unsigned char d=0;
;	genAssign
	mov	dptr,#_atob_d_1_1
;	Peephole 181	changed mov to clr
	clr	a
	movx	@dptr,a
;	atoh.c:208: for(i=0;i<8;i++)
;	genAssign
	mov	r2,#0x08
	mov	r3,#0x00
00103$:
...
;------------------------------------------------------------
;a                         Allocated with name '_atoi_a_1_1'
;temp_result               Allocated with name '_atoi_temp_result_1_1'
;i                         Allocated with name '_atoi_i_1_1'
;------------------------------------------------------------
;	atoh.c:228: int atoi(char *a)
;	-----------------------------------------
;	 function atoi
;	-----------------------------------------
_atoi:
;	genReceive
	...
	mov	a,r2
	movx	@dptr,a
;	atoh.c:232: temp_result=0;
;	genAssign
	mov	dptr,#_atoi_temp_result_1_1
	clr	a
	movx	@dptr,a
	inc	dptr
	movx	@dptr,a
;	atoh.c:233: while(*(a+i)!='\0') //Convert ascii values to integer
;	genAssign
	mov	dptr,#_atoi_a_1_1
	movx	a,@dptr
	mov	r2,a
...
;	atoh.c:235: temp_result = temp_result * 10 + ( *(a+i)- '0' );
;	genIpush
	push	ar2
	push	ar3
	push	ar4
