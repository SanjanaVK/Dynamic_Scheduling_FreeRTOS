   ...
   08FC 12 17 80            500 	lcall	_lcdputcmd
                            ...
                            502 ;	genIpush
   08FF 74 64               503 	mov	a,#__str_0
   0901 C0 E0               504 	push	acc
   0903 74 4E               505 	mov	a,#(__str_0 >> 8)
   0905 C0 E0               506 	push	acc
                            507 ;	genCall
   0907 12 3B D4            508 	lcall	_printf_tiny
   ...
   0922                     529 00136$:
                            ...
                            531 ;	genAssign
   0922 90 01 B2            532 	mov	dptr,#__modsint_PARM_2
   ...
   0935 12 3E 0E            544 	lcall	__modsint
   ...
   094E 74 7F               565 	mov	a,#__str_1
   0950 C0 E0               566 	push	acc
   0952 74 4E               567 	mov	a,#(__str_1 >> 8)
   0954 C0 E0               568 	push	acc
                            569 ;	genCall
   0956 12 3B D4            570 	lcall	_printf_tiny
   ...
   0993 12 38 97            606 	lcall	_putchar
   ...
   09AD 12 15 FF            626 	lcall	_lcdgotoxy
                            ...
                            628 ;	genIpush
   09B0 74 84               629 	mov	a,#__str_2
   09B2 C0 E0               630 	push	acc
   09B4 74 4E               631 	mov	a,#(__str_2 >> 8)
   09B6 C0 E0               632 	push	acc
                            633 ;	genCall
   09B8 12 3B D4            634 	lcall	_printf_tiny
   ...
   09D3                     655 00139$:
                            ...
                            657 ;	genAssign
   09D3 90 01 B2            658 	mov	dptr,#__modsint_PARM_2
   ...
   09E6 12 3E 0E            670 	lcall	__modsint
   ...
   0A02 74 7F               691 	mov	a,#__str_1
   0A04 C0 E0               692 	push	acc
   0A06 74 4E               693 	mov	a,#(__str_1 >> 8)
   0A08 C0 E0               694 	push	acc
                            695 ;	genCall
   0A0A 12 3B D4            696 	lcall	_printf_tiny
   ...
   0A3B C0 E0               732 	push	acc
                            733 ;	genIpush
   0A3D 74 9D               734 	mov	a,#__str_3
   0A3F C0 E0               735 	push	acc
   0A41 74 4E               736 	mov	a,#(__str_3 >> 8)
   0A43 C0 E0               737 	push	acc
                            738 ;	genCall
   0A45 12 3B D4            739 	lcall	_printf_tiny
   ...
   0A68 C0 E0               767 	push	acc
                            768 ;	genIpush
   0A6A 74 9D               769 	mov	a,#__str_3
   0A6C C0 E0               770 	push	acc
   0A6E 74 4E               771 	mov	a,#(__str_3 >> 8)
   0A70 C0 E0               772 	push	acc
                            773 ;	genCall
   0A72 12 3B D4            774 	lcall	_printf_tiny
   ...
   0A94 C0 E0               803 	push	acc
                            804 ;	genIpush
   0A96 74 9D               805 	mov	a,#__str_3
   0A98 C0 E0               806 	push	acc
   0A9A 74 4E               807 	mov	a,#(__str_3 >> 8)
   0A9C C0 E0               808 	push	acc
                            809 ;	genCall
   0A9E 12 3B D4            810 	lcall	_printf_tiny
   ...
   0ABA C0 E0               829 	push	acc
                            830 ;	genIpush
   0ABC 74 9D               831 	mov	a,#__str_3
   0ABE C0 E0               832 	push	acc
   0AC0 74 4E               833 	mov	a,#(__str_3 >> 8)
   0AC2 C0 E0               834 	push	acc
                            835 ;	genCall
   0AC4 12 3B D4            836 	lcall	_printf_tiny
   ...
   0AF1 C0 06               864 	push	ar6
                            865 ;	genIpush
   0AF3 74 A5               866 	mov	a,#__str_4
   0AF5 C0 E0               867 	push	acc
   0AF7 74 4E               868 	mov	a,#(__str_4 >> 8)
   0AF9 C0 E0               869 	push	acc
                            870 ;	genCall
   0AFB 12 3B D4            871 	lcall	_printf_tiny
   ...
   0B21 12 38 97            909 	lcall	_putchar
   ...
   0B3C                     930 00114$:
                            ...
                            932 ;	genAssign
   0B3C 90 01 B2            933 	mov	dptr,#__modsint_PARM_2
   ...
   0B4D 12 3E 0E            944 	lcall	__modsint
   ...
   0B63 C0 03               960 	push	ar3
                            961 ;	genIpush
   0B65 74 9D               962 	mov	a,#__str_3
   0B67 C0 E0               963 	push	acc
   0B69 74 4E               964 	mov	a,#(__str_3 >> 8)
   0B6B C0 E0               965 	push	acc
                            966 ;	genCall
   0B6D 12 3B D4            967 	lcall	_printf_tiny
   ...
   0B90 12 38 97            988 	lcall	_putchar
   ...
   0BA1 C0 05              1000 	push	ar5
                           1001 ;	genIpush
   0BA3 74 AA              1002 	mov	a,#__str_5
   0BA5 C0 E0              1003 	push	acc
   0BA7 74 4E              1004 	mov	a,#(__str_5 >> 8)
   0BA9 C0 E0              1005 	push	acc
                           1006 ;	genCall
   0BAB 12 3B D4           1007 	lcall	_printf_tiny
   ...
   4E64                    1027 __str_0:
   4E64 0A                 1028 	.db 0x0A
   4E65 0D                 1029 	.db 0x0D
   4E66 09                 1030 	.db 0x09
   4E67 09                 1031 	.db 0x09
   4E68 41 73 63 69 69 20  1032 	.ascii "Ascii Representation"
        52 65 70 72 65 73
        65 6E 74 61 74 69
        6F 6E
   4E7C 0A                 1033 	.db 0x0A
   4E7D 0D                 1034 	.db 0x0D
   4E7E 00                 1035 	.db 0x00
   4E7F                    1036 __str_1:
   4E7F 0A                 1037 	.db 0x0A
   4E80 0D                 1038 	.db 0x0D
   4E81 09                 1039 	.db 0x09
   4E82 09                 1040 	.db 0x09
   4E83 00                 1041 	.db 0x00
   4E84                    1042 __str_2:
   4E84 0A                 1043 	.db 0x0A
   4E85 0D                 1044 	.db 0x0D
   4E86 09                 1045 	.db 0x09
   4E87 09                 1046 	.db 0x09
   4E88 48 65 78 20 52 65  1047 	.ascii "Hex Representation"
        70 72 65 73 65 6E
        74 61 74 69 6F 6E
   4E9A 0A                 1048 	.db 0x0A
   4E9B 0D                 1049 	.db 0x0D
   4E9C 00                 1050 	.db 0x00
   4E9D                    1051 __str_3:
   4E9D 0A                 1052 	.db 0x0A
   4E9E 0A                 1053 	.db 0x0A
   4E9F 0D                 1054 	.db 0x0D
   4EA0 30 78 25 78        1055 	.ascii "0x%x"
   4EA4 00                 1056 	.db 0x00
   4EA5                    1057 __str_4:
   4EA5 09                 1058 	.db 0x09
   4EA6 20 25 78           1059 	.ascii " %x"
   4EA9 00                 1060 	.db 0x00
   4EAA                    1061 __str_5:
   4EAA 25 78              1062 	.ascii "%x"
   4EAC 00                 1063 	.db 0x00
